...
if ($_GET['form'] == 'add') { ?>
    <div class="container-fluid">
        <div class="fade-in">
            ...
            <div class="col-sm-6">
                <h1><i class="fa fa-edit icon-title"></i> Agregar Ventas</h1>
            </div>
            <div class="card">
                <div class="card-header"><strong>Formulario de Ventas</strong></div>
                <form action="modules/ventas/process.php?act=insert" method="POST" class="form-horizontal">
                    <div class="card-body">
                        <?php
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-4">
                                <select class="form-control" name="cod_deposito" required>
