...
if(empty($_SESSION['username']) && empty($_SESSION['password'])){
    ...
    if($_GET['act']=='insert'){
        if(isset($_POST['Guardar'])){
            ...
            $query = mysqli_query($mysqli, "INSERT INTO u_medida (id_u_medida, u_descrip) VALUES ($codigo,'$u_descrip')") or die('error'.mysqli_error($mysqli));
    ...
    elseif ($_GET['act']=='delete') {
        if(isset($_GET['id_u_medida'])){
            ...
            $query = mysqli_query($mysqli, "DELETE FROM u_medida WHERE id_u_medida = $codigo") or die('error'.mysqli_error($mysqli));
