...
if (!$fecha_desde || !$fecha_hasta || !$estado) {
    echo "<script>alert('Debe aplicar un filtro primero (fecha desde y hasta y el estado).'); window.close(); window.location.href='http://localhost/proyecto_mt/main.php?module=info_pedido';</script>";
    exit;
}
...
<body>
        ...
        <div>
            ...
            <table width="100%" align="center"> <!-- Uso de align="center" para compatibilidad -->
                <thead>
                    <tr>
                        <th height="20" align="center" valign="middle">ID Pedido</th>
