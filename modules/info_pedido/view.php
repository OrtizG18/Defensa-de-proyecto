        ...
        <div class="col">
            ...
            if ($fecha_desde && $fecha_hasta && $estado) {
                $query = mysqli_query($mysqli, "
                    ...
                    WHERE fecha BETWEEN '$fecha_desde' AND '$fecha_hasta'
                      AND estado = '$estado' ORDER BY id_pedido ASC
            ...
            <div class="card mt-4">
                <div class="card-header">
                    ...
                    <div class="col-mt-12">
                        <a href='modules/info_pedido/print.php?act=imprimir&fecha_desde=<?php echo $fecha_desde;?>&fecha_hasta=<?php echo $fecha_hasta; ?>&estado=<?php echo $estado ?>' target="blank_">
